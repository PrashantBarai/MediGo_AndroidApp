...
export default function Login() {
  ...
  const handleLogin = () => {
    ...
    if (email && password) {
      router.replace('/(customer)/(tabs)/home/home');
    }
  };

  const handleSwitchToPharmacy = () => {
    router.push('/(auth)/pharmacy/login');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <Text style={styles.description}>Please login to get your medicine at your door steps.</Text>
        ...
        <TouchableOpacity 
          ...
          onPress={handleSwitchToPharmacy}
        >
          <Ionicons name="medical" size={20} color="#6C63FF" />
          <Text style={styles.switchText}>Switch to Pharmacy Login</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
